...
class FeatureExtractor:
    ...
    def get_total_exec_features(self):
        total_features = self.path_features + self.code_feature + self.semantics_features + self.url_features + self.repo_homepage_feature + self.email_rank_feature + [self.read_me_flag]
