...
class FeatureExtractor:
    ...
    def total_features(self):
        ...
        """
        total_features = self.file_features + self.code_features + self.semantics_features + self.url_features + self.license_features + self.repo_features + self.ctx_features
